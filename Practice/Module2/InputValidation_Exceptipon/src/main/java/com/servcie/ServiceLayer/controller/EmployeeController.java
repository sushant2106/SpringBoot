...
//        return employeeDTO.map(employeeDTO1 -> ResponseEntity.ok(employeeDTO)).orElse(ResponseEntity.notFound().build());
    ...
    @GetMapping
    public ResponseEntity<List<EmployeeDTO>> getAllEmployees(@RequestParam(required=false,name="inputAge") Integer age, @RequestParam(required = false) String sortBy)throws  ResourceNotFoundException{
    ...
    public  ResponseEntity<EmployeeDTO> updateEmployeeById(@RequestBody @Valid EmployeeDTO employeeDTO,@PathVariable Long emloyeeId) throws ResourceNotFoundException{
    ...
    public  ResponseEntity<Boolean> deleteEmployeeById(@PathVariable Long emloyeeId) throws ResourceNotFoundException {
    ...
    public ResponseEntity<EmployeeDTO> updatePartialEmployeeById(@RequestBody Map<String,Object> updates,@PathVariable Long employeeId)throws  ResourceNotFoundException{
